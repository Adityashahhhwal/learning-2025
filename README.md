...
<strong>Deliberate practice across frontend, backend, and core CS foundations.</strong><br/>
<p>
...
|-------|------------------|---------|--------------|
| Full-Stack Foundations | Frontend fundamentals (shipping small UI projects) | Git, vanilla JS, browser devtools | Feb 2026 |
...
Near Term Shift: Introduce backend (Node.js + Express) + data persistence (JSON store → SQLite/PostgreSQL) while continuing small frontend iterations.

---

## 2. Featured Project

**Amazon Project (E-commerce UI)**
...
## 3. Project Portfolio (Incremental)
...
## 6. Computer Science Practice Plan
...
Tracking: Add brief notes in `cs-notes/` with solution rationale; emphasize clarity over clever optimizations early.
...
## 8. Quality Checklist (per Project)
...
2. Use a local server (Live Server or similar) so ES modules load correctly.
